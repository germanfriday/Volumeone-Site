...
<head>
<title>Volumeone | Graphics | Mean Streak. Poster, Tote, T-Shirt, Motion piece</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Mean Streak. Poster, Tote, T-Shirt, Motion piece</h1>
			
			<p class="description">
To commemorate 10 years in the borough of Brooklyn, Mean Streak takes cues from the poster for the 1973 Scorcese movie "Mean Streets." Utilizing objects from The New York landscape combined with an autumnal palette, Mean Streak celebrates the energy of the city.
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="nationaltrainday.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/mean1.jpg" width="617" height="750" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/mean2.jpg" width="617" height="750" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/mean3.jpg" width="617" height="750" alt="" />
					</li>
