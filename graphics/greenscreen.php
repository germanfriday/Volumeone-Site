...
<head>
<title>Volumeone | Motion | Sundance Channel. Green Screen</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Sundance Channel. Green Screen</h1>
			
			<p class="description">
			2 minute promo for Sundance Channel focusing on green screen. Co-developed with <a href="http://www.imdb.com/name/nm0928139/" target="_blank">Chris Wilcha</a> and  <a href="http://www.amoebalabs.com/" target="_blank">David Ahuja</a>.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="foley.php">Next Project</a>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/green_screen.jpg',
								'media/green_screen.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
								'bgcolor', 'white',
						...
						<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
							<param name="src" value="media/green_screen.jpg" />
							<param name="href" value="media/green_screen.mov" />
							<param name="target" value="myself" />
							<param name="controller" value="true" />
							<param name="autoplay" value="true" />
							<param name="scale" value="aspect" />
							<embed width="630" height="358" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/"
								src="media/green_screen.jpg"
								href="green_screen.mov"
								target="myself"
								controller="true"
								autoplay="true"
								scale="aspect">
