...
<head>
<title>Volumeone | Graphics | Suspension of Disbelief. Booklet and Sticker Sheet</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>	 Suspension of Disbelief. Booklet and Sticker Sheet</h1>
			
			<p class="description">
Suspension of Disbelief is comprised of a 10 page booklet with a three panel fold-out. The illustrations within the booklet were created in conjunction with a sticker sheet and motion piece. The overall approach was to create a shoots-and-ladders type world where all of the various objects could interact with one another.
<br /><br /> 
<a href="../motion/suspension.php" target="_blank">Watch the movie</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="earth.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/hang1.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/hang2.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/hang3.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/hang4.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_5" class="slide image ">
						<img src="media/hang5.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_6" class="slide image ">
						<img src="media/hang6.jpg" width="617" height="850" alt="" />
					</li>
