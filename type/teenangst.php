...
<head>
<title>Volumeone | Type | Teen Angst Series</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Teen Angst. Poster Series</h1>
			
			<p class="description">
				Poster series inspired by teen rebellion and the movies "Over the Edge" and "The Outsiders."
			</p>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/teen1.jpg" width="617" height="791" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/teen2.jpg" width="617" height="791" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/teen3.jpg" width="617" height="791" alt="" />
					</li>
