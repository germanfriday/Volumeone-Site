...
<head>
<title>Volumeone | Type | Glamour UK</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Glamour UK. Your Postcode Your Sex Life</h1>
			
			<p class="description">
Custom illustrated title treatment and eight city names developed for an article about how your post code affects your sex life. <p>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="logos.php">Next Project</a>
		</div>
	...
	<div class="right_col">
		<div class="slideshow">
			<ul><!-- only first li has "cur" class (used by slideshow js)-->
				
				<li id="slide_1" class="slide image cur">
					<img src="media/ukglamour1.jpg" width="617" height="694" alt="" />
				</li>

				
				<li id="slide_2" class="slide image ">
					<img src="media/ukglamour2.jpg" width="617" height="694" alt="" />
				</li>

				
				<li id="slide_3" class="slide image ">
					<img src="media/ukglamour3.jpg" width="617" height="694" alt="" />
				</li>

				
				<li id="slide_4" class="slide image ">
					<img src="media/ukglamour4.jpg" width="617" height="694" alt="" />
				</li>

				
				<li id="slide_5" class="slide image ">
					<img src="media/ukglamour5.jpg" width="617" height="694" alt="" />
				</li>
