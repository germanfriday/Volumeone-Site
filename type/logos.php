...
<head>
<title>Volumeone | Type | Logos and Marks</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Logos and Marks</h1>
			
			<p class="description">
A curated collection wordmarks, logos and brands developed for a variety of clients.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="newyorkmag_00s.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/neonandsons.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/prettyempire.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/tallback.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/trueslant.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_5" class="slide image ">
						<img src="media/dfl.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_6" class="slide image ">
						<img src="media/ak.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_7" class="slide image ">
						<img src="media/trl.jpg" width="617" height="581" alt="" />
					</li>

					
					<li id="slide_8" class="slide image ">
						<img src="media/champ.jpg" width="617" height="581" alt="" />
					</li>
