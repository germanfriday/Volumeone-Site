...
<head>
<title>Volumeone | Type | Merde Profonde</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Merde Profonde. 12 Inch Record Sleeve</h1>
			
			<p class="description">
	Custom typography and design for Merde Profonde. 12 Inch Record Sleeve. 
 <p>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="espn.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul><!-- only first li has "cur" class (used by slideshow js)-->
				<li id="slide_1" class="slide image cur"> 
					<img src="media/merde1.jpg">
				</li>
				<li id="slide_2" class="slide image"> 
					<img src="media/merde2.jpg">
				</li>
