...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
				Illustrated type for ESPN Magazine's table of contents. <br /><br />
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="teenangst.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/espn1.jpg" width="617" height="735" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/espn2.jpg" width="617" height="735" alt="" />
					</li>
