...
<head>
<title>Volumeone | Type | Friend of Type</title>
...
<!-- * * * * * * * * NEW CODE * * * * * * * * -->
<body id="type" class="project"> <!-- tag closed in footer.php -->
<!-- * * * * * * End: NEW CODE * * * * * * * * -->
...
<div id="header">
	...
	<div class="top_nav">
		<ul>
			<!-- * * * * * * * * NEW CODE * * * * * * * * -->
			<li class="nav_Type">
				<a class="active" href="index.html"><span>Type</span></a>
			</li>
			<li class="nav_Motion">
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Friends of Type</h1>
			
			<p class="description">
Fourteen custom type illustrations developed for <a href="http://www.friendsoftype.com" target="_blank">Friends of Type<a/>. The concept behind the treatments was to pay homage to the true letters of the 70's namely Tom Carnase and Tony Di Spigna.<p>
		...
		<div class="sidebar_nav">
			<a href="index.php">Back to Type</a>
			<span>/</span>
			<a href="vanityfair.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/fot1.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/fot2.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/fot3.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/fot4.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_5" class="slide image ">
						<img src="media/fot5.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_6" class="slide image ">
						<img src="media/fot6.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_7" class="slide image ">
						<img src="media/fot7.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_8" class="slide image ">
						<img src="media/fot8.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_9" class="slide image ">
						<img src="media/fot9.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_10" class="slide image ">
						<img src="media/fot10.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_11" class="slide image ">
						<img src="media/fot11.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_12" class="slide image ">
						<img src="media/fot12.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_13" class="slide image ">
						<img src="media/fot13.jpg" width="617" height="617" alt="" />
					</li>

					
					<li id="slide_14" class="slide image ">
						<img src="media/fot14.jpg" width="617" height="617" alt="" />
					</li>
