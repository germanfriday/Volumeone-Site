...
<head>
<title>Volumeone | Type | New York Magazine | The 00s</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>New York Magazine. The Zero Zeros</h1>
			
			<p class="description">
				For the cover of the ’00s Issue of New York Magazine, Volumeone was invited to illustrate and interpret “’00s.”
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="nytimes_semantic.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/001.jpg" width="617" height="806" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/002.jpg" width="617" height="806" alt="" />
					</li>
