...
<head>
<title>Volumeone | Type | Super Street Fighter IV</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Super Street Fighter IV</h1>
			
			<p class="description">
				To promote the new Super Street Fighter IV video game, logos were created for each character as well as additional graphic elements. All branding was then integrated into final storyboards and animation for the 30 second commercial to promote the game. <br /><br />
				<p>
				<a href="../motion/ssfiv.php">Watch the commercial</a>
				</p>	
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="philly.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/ssfiv1.jpg" width="617" height="806" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/ssfiv2.jpg" width="617" height="806" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/ssfiv3.jpg" width="617" height="806" alt="" />
					</li>
