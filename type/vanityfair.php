...
<head>
<title>Volumeone | Type | Vanity Fair Best Dressed List</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Vanity Fair Best Dressed List</h1>
			
			<p class="description">
Illustrated type treatment created for the Vanity Fair 100 and the Vanity Fair 1020 Best Dressed List. <p>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="ukglamour.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
					<ul>
							...
							<li id="slide_1" class="slide image cur">
								<img src="media/vf_100.jpg" width="617" height="694" alt="" />
							</li>

							
							<li id="slide_2" class="slide image ">
								<img src="media/vf_best1.jpg" width="617" height="694" alt="" />
							</li>

							
							<li id="slide_3" class="slide image ">
								<img src="media/vf_best2.jpg" width="617" height="694" alt="" />
							</li>
