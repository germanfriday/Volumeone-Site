...
<head>
<title>Volumeone | Type | New York Times Magazine | On Language</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>New York Times Magazine. <p>On Language</p></h1>
			
			<p class="description">
  Typography created for the article "Semantic Time Travel" for New York Times Magazine's On Language section. The article is about the Historical Thesaurus of the Oxford English Dictionary, which claims to be the first reference work of its kind — a thesaurus that allows you to search for synonyms by historical era. <br /><a href="http://www.nytimes.com/2010/01/10/magazine/10FOB-onlanguage-t.html">New York Times Magazine - Semantic Time Travel</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="typeandimage.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/semantic1.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/semantic2.jpg" width="617" height="694" alt="" />
					</li>
