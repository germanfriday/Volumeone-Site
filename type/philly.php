...
<head>
<title>Volumeone | Type | Philly</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>University of the Arts</h1>
			
			<p class="description">
				Illustrative type to promote the Periodic Lecture Series at the University of the Arts, Philadelphia. The custom Philly type is surrounded by line art illustrations of iconic Philadelphia landmarks, people and culture.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="road.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/philly1.jpg" width="617" height="688" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/philly3.jpg" width="617" height="688" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/philly4.jpg" width="617" height="688" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/philly5.jpg" width="617" height="688" alt="" />
					</li>
