...
<head>
<title>Volumeone | Type | Lubalin Now</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Lubalin Now. Exhibition Type</h1>
			
			<p class="description">
Little Eden and Jukebox Romeo are hand-drawn script type treatments created for the exhibition Lubalin Now at the Cooper Union. Lubalin Now was the inaugural exhibition in the newly re-located Herb Lubalin Study Center of Design and Typography.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="illustrativetype.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/jukeboxromeo.jpg" width="617" height="980" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/littleeden.jpg" width="617" height="980" alt="" />
					</li>
