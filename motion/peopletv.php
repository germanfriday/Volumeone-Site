...
<head>
<title>Volumeone | Motion | People TV</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>People TV. <br />Channel Branding and Show Packages</h1>
			
			<p class="description">
People.com worked with Volumeone and <a href="http://www.athleticnyc.com" target="_bank">Athletics</a> to re-brand all of their daily video content and create People TV. First, Volumeone developed the "TV" logo lock-up as well as developing the byline "Celebrities worth watching." All channel branding was executed in 7 colors and includes logo resolves, generic openers, bumpers, lower thirds and transitions. In additional to channel branding, 5 mini-show packages were created for primary programming. The entire system was developed in a modular fashion so that People.com staff can easily swap out celebrity footage.</p><br />
<bv />
			<p>
			<a href="http://www.people.com/people/videos/" target="_bank">Watch People TV</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="ssfiv.php">Next Project</a>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/peopletv.jpg',
								'media/peopletv.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
