...
<head>
<title>Volumeone | Motion | Spaceship Earth</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
				Short form motion piece. Spaceship Earth is a prog rock journey into a world of alien pyramids, space dolphins, skeleton astronauts and a hand-drawn earth logo n the vintage "YES" style.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="chinagirl.php">Next Project</a>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/earth.jpg',
								'media/earth.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
						...
						<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
							<param name="src" value="media/earth.jpg" />
							<param name="href" value="media/earth.mov" />
