...
<head>
<title>Volumeone | Motion | Suspension of Disbelief</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Suspension of Disbelief</h1>
			
			<p class="description">
Short form motion piece. A magical world of mischief, memory and imagination..
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="spaceshipearth.php">Next Project</a>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/hangin.jpg',
								'media/hangin.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
