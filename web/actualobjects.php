...
<head>
<title>Volumeone | Web | Actual Objects</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Actual Objects</h1>
			
			<p class="description">
Volumeone and <a href="http://www.athleticsnyc.com/" target="_blank">Athletics</a> worked with Actual Objects, a web startup offering high-production-value design assets, to develop the Actual Objects name and brand identity, as well as the site information architecture, user experience, and visual design			</p><br />

						<p>
						<a href="http://www.actualobjects.com/" target="_blank">Visit the Actual Objects website</a>
						</p>
		</div>
		...
		<div class="slideshow_controls">
			...
			<a class="next" href="pcpa.php">Next</a>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="pcpa.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/actualobjects1.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/actualobjects2.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/actualobjects3.jpg" width="617" height="524" alt="" />
					</li>
