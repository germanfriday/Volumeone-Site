...
<head>
<title>Volumeone | Web | DKNY Jeans</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
			  Design and development for the DKNY Jeans site. Developed with Athletics partner Jason Gnewikow.</p><br />			 
			<p>
			<a href="http://www.dknyjeans.com" target="_blank">Visit the DKNY Jeans website</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="trueslant.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/dkny1.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/dkny2.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/dkny3.jpg" width="617" height="524" alt="" />
					</li>
