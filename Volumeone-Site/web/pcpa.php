...
<head>
<title>Volumeone | Web | Pelli Clarke Pelli Architects</title>
...
<!-- * * * * * * * * NEW CODE * * * * * * * * -->
<body id="web" class="project"> <!-- tag closed in footer.php -->
<!-- * * * * * * End: NEW CODE * * * * * * * * -->
...
<div id="header">
	...
	<div class="top_nav">
		<ul>
			...
			<li class="nav_Web">
				<a class="active" href="index.html"><span>Web</span></a>
			</li>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Pelli Clarke Pelli Architects</h1>
			
			<p class="description">
			  Site information architecture, design and development of the Pelli Clarke Pelli Architects website. Located in New Haven, CT, Pelli Clarke Pelli have designed many of the world's most recognizable buildings. Their award-winning portfolio includes academic buildings, libraries, museums, research centers, residences and master plans. Site features a full-screen Flash user experience, and integration with Adminkit, a comprehensive client administrative suite of site content management tools created by <a href="http://www.athleticsnyc.com/" target="_blank">Athletics</a>.</p><br />
			
			<p>
			<a href="http://www.pcparch.com/" target="_blank">Visit the Pelli Clarke Pelli website</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="dknyjeans.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/pcpa1.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/pcpa2.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/pcpa3.jpg" width="617" height="524" alt="" />
					</li>
