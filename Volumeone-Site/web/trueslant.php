...
<head>
<title>Volumeone | Web | True Slant</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
Volumeone worked with <a href="http://www.athleticsnyc.com/" target="_blank">Athletics</a> to develop the True/Slant name and brand identity as well as initial visual site design. As of June of 2010, True/Slant has over 1 million unique visitors a month and has been acquired by Forbes.</p><br />

			<p>
			<a href="http://www.trueslant.com/" target="_blank">Visit the True Slant website</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="../seasons/index.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/trueslant1.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/trueslant2.jpg" width="617" height="524" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/trueslant3.jpg" width="617" height="524" alt="" />
					</li>
