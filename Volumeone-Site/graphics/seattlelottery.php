...
<head>
<title>Volumeone | Graphics | Washington State Lottery</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Washington State Lottery. You Deserve a Bonus Campaign</h1>
			
			<p class="description">
Volumeone worked with <a href="http://www.coleweber.com/">Cole & Weber United</a> to create a modular graphics system for the Washington State Lottery "You Deserve a Bonus" Campaign. The system consists of custom type treatments, a variable color palette and a library of backgrounds, borders and graphic elements used to create print ads, billboards and website graphics.
			</p>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/lotto1.jpg" width="617" height="930" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/lotto2.jpg" width="617" height="930" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/lotto3.jpg" width="617" height="930" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/lotto4.jpg" width="617" height="930" alt="" />
					</li>

					
					<li id="slide_5" class="slide image ">
						<img src="media/lotto5.jpg" width="617" height="930" alt="" />
					</li>
