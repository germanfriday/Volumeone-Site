...
<head>
<title>Volumeone | Graphics | Spaceship Earth. Logo, Print and Motion piece</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Spaceship Earth. Logo, Poster, Shirt and Motion piece</h1>
			
			<p class="description">
Spaceship Earth was created in homage to our blue planet. The motion piece was featured on Heineken Greenspace and was shown in conjunction with a larger installation.

<br /><br /> 
<a href="../motion/spaceshipearth.php" target="_blank">Watch the movie</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="broken.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/earth1.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/earth2.jpg" width="617" height="850" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/earth3.jpg" width="617" height="850" alt="" />
					</li>
