...
<head>
<title>Volumeone | Graphics | Zoo York. Urbane Jungle</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>The Urbane Jungle. Zoo York Skateboards.</h1>
			
			<p class="description">
Zoo York asked <a href="http://www.lifeofthemind.net" target="_blank">Mark Owens</a> and <a href="http://www.volumeone.com" target="_blank">Matt Owens</a> to develop a line of six skateboards for their artist series. The six boards represent the socio-cultural realms of Literature, Architecture, The Arts, Transit, Food and Tourism. Together the series encompasses New York's 'Urbane Jungle.'
			</p>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/zy1.jpg" width="617" height="715" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/zy2.jpg" width="617" height="715" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/zy3.jpg" width="617" height="715" alt="" />
					</li>
