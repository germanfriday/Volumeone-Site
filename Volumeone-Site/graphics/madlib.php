...
<head>
<title>Volumeone | Motion | Madlib. Slims Return</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Madlib. Slim's Return</h1>
			
			<p class="description">
			Co-developed with <a href="hhttp://www.amoebalabs.com/" target="_blank">David Ahuja</a>, Madlib's Slim's Return video was created to promote Blue Note Records release of "Madlib - Shades of Blue."</a>.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="peopletv.php">Next Project</a>
		</div>
				...
				<ul><br /><center>
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/madlib.jpg',
								'media/madlib.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
