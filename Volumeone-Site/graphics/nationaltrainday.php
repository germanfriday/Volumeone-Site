...
<head>
<title>Volumeone | Graphics | National Train Day 2011</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>National Train Day</h1>
			
			<p class="description">
Volumeone worked with <a href="http://www.http//www.arn.com/">Arnold Worldwide</a> to develop all typography, graphics and other campaign components for Amtrak sponsored Nation Train Day. the graphic system was translated into posters, print materials, buttons, train wraps and banners. For more information, visit <a href="http://www.nationaltrainday.com/">http://www.nationaltrainday.com/</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="forbes.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/ntd1.jpg" width="617" height="795" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/ntd2.jpg" width="617" height="795" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/ntd3.jpg" width="617" height="795" alt="" />
					</li>
