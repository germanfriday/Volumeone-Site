...
<head>
<title>Volumeone | Graphics | Bloomberg Businessweek</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Bloomberg Businessweek. Graphics and Icons</h1>
			
			<p class="description">
Graphics, Icons and symbols developed for articles featured in Bloomberg Businessweek.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="aiga.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/bloomberg2.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/bloomberg4.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/bloomberg3.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/bloomberg1.jpg" width="617" height="694" alt="" />
					</li>
