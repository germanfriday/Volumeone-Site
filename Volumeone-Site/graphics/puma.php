...
<head>
<title>Volumeone | Graphics | Athletics For Puma</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>	 Athletics For Puma</h1>
			
			<p class="description">
Matt Owens and Jason Gnewikow collaborated to create a line of custom graphics and print materials exclusively for Puma stores. Silhouettes of broken sports equipment were used to express the strength of the brand while other graphics used images of house cats and a fluorescent palette to provide a level of humor to the line. All graphics were translated into t-shirts, postcards and stickers. Custom "Athletics for Puma" labels and other branding were also created. 
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="meanstreak.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/puma1.jpg" width="617" height="700" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/puma2.jpg" width="617" height="700" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/puma3.jpg" width="617" height="700" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/puma4.jpg" width="617" height="700" alt="" />
					</li>

					
					<li id="slide_5" class="slide image ">
						<img src="media/puma5.jpg" width="617" height="700" alt="" />
					</li>
