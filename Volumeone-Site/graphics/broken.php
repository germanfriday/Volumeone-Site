...
<head>
<title>Volumeone | Graphics | Broken Studies</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Broken Studies</h1>
			
			<p class="description">
	The Broken Studies Project inspired some of the work we did for Puma. Layers of graphics were applied are silk screen silhouettes. The remaining graphic elements were created using frisket film stencils. 
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="puma.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/broken1.jpg" width="617" height="544" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/broken2.jpg" width="617" height="544" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/broken3.jpg" width="617" height="544" alt="" />
					</li>
