...
<head>
<title>Volumeone | Graphics | Good Magazine. State of the Planet</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Good Magazine. State of the Planet.</h1>
			
			<p class="description">
Graphics and symbols designed to re-cap statistics for the state of planet earth.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="fastcompany2.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/sop1.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/sop2.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/sop3.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/sop4.jpg" width="617" height="694" alt="" />
					</li>
