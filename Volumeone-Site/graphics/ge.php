...
<head>
<title>Volumeone | Graphics | General Electric</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>General Electric. Electric Vehicle Infrastructure.</h1>
			
			<p class="description">
Information graphics designed for General Electric articulating GE's Electric Vehicle Infrastructure strategy. <The full information graphic can be found here><a href="http://www.ge.com/visualization/ev_infrastructure" target="_blank">See the Full Information Graphic</a>
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="bloomberg.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/ge1.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/ge2.jpg" width="617" height="694" alt="" />
					</li>
