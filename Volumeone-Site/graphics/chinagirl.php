...
<head>
<title>Volumeone | Motion | Sundance Channel. China Girl</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Sundance Channel. China Girl</h1>
			
			<p class="description">
			2 minute promo for Sundance Channel focusing on film color calibration. Co-developed with <a href="http://www.imdb.com/name/nm0928139/" target="_blank">Chris Wilcha</a> and  <a href="http://www.amoebalabs.com/" target="_blank">David Ahuja</a>.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="greenscreen.php">Next Project</a>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/china_girl.jpg',
								'media/china_girl.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
								'bgcolor', 'white',
