...
<head>
<title>Volumeone | Forbes 400</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Forbes Magazine.</h1>
			
			<p class="description">
Working with Jason Gnewikow, fellow studio partner at <a href="http://www.athleticsnyc.com" target="_blank">Athletics</a>, we worked with Forbes internal design team to re-envision Forbes Magazine. The redesign encompassed the creation of new article templates, features, graphics, icons and photo illustrations. A new approach to the Forbes 400 list was also created that utilizes a modular information hierarchy to easily display information. The new design and template conventions will be used as the foundation for future issues of Forbes Magazine.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="zooyork.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/forbes10.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/forbes11.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/forbes12.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_4" class="slide image ">
						<img src="media/forbes13.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_5" class="slide image ">
						<img src="media/forbes7.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_6" class="slide image ">
						<img src="media/forbes1.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_7" class="slide image ">
						<img src="media/forbes8.jpg" width="617" height="694" alt="" />
					</li>

					
					<li id="slide_8" class="slide image ">
						<img src="media/forbes9.jpg" width="617" height="694" alt="" />
					</li>
