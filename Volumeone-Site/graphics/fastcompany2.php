...
<head>
<title>Volumeone | Graphics | Fast Company</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Fast Company. <br />Information Graphics and Icons.</h1>
			
			<p class="description">
Fast Company required the creation of an icon set for an article about Women innovators in technology.
<br /><br />
Fast Company also required the creation of an information graphic that compared brand loyalty statistics between Dunkin' Donuts and Startbucks.
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/fastco1.jpg" width="617" height="621" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/fastco2.jpg" width="617" height="609" alt="" />
					</li>
