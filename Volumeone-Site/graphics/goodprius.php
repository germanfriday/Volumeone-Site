...
<head>
<title>Volumeone | Graphics | Good Magazine. Prius</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
Three Information graphics were developed for Good Magazine for the Prius ‘Harmony” campaign. The information graphics feature statistics on Renewable Energy, Education and Hunger.  
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="goodsop.php">Next Project</a>
		</div>
		...
		<div class="slideshow">
			<ul>
					...
					<li id="slide_1" class="slide image cur">
						<img src="media/gp1.jpg" width="617" height="800" alt="" />
					</li>

					
					<li id="slide_2" class="slide image ">
						<img src="media/gp2.jpg" width="617" height="800" alt="" />
					</li>

					
					<li id="slide_3" class="slide image ">
						<img src="media/gp3.jpg" width="617" height="800" alt="" />
					</li>
