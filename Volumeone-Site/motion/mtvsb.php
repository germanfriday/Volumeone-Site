...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>MTV Spring Break</h1>
			
			<p class="description">
Design, Animation and Music for MTV, MTV2 and MTVU Spring Break Show Packaging. Animation and audio developed with <a href="http://www.athleticsnyc.com/" target="_blank">Athletics</a> member <a href="http://www.amoebalabs.com" target="_blank">David Ahuja</a>.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="vh1leak.php">Next Project</a>
			...
			<ul><br />
				<li id="slide_1" class="slide video">
					<script type="text/javascript"><!--
						QT_WritePoster_XHTML('', 'media/mtv_sb.jpg',
							'media/mtv_sb.mov',
							'630', '354', '',
							'controller', 'true',
							'autoplay', 'true',
