...
<head>
<title>Volumeone | Motion | VH1 The Leak</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
Promo package for VH1's The Leak. Developed with Athletics member <a href="http://www.lifeofthemind.net">Mark Owens</a>
			</p>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/vh1_leak.jpg',
								'media/vh1_leak.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
						...
						<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
							<param name="src" value="media/vh1_leak.jpg" />
							<param name="href" value="media/vh1_leak.mov" />
