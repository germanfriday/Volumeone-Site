...
<head>
<title>Volumeone | Motion | Showreel</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
				A selection of our latest motion work.
			</p>
		</div>
			...
			<ul><br />
				<li id="slide_1" class="slide video">
					<script type="text/javascript"><!--
						QT_WritePoster_XHTML('', 'media/reel_poster.jpg',
							'media/SHOWREEL_600.mov',
							'630', '354', '',
							'controller', 'true',
							'autoplay', 'true',
							'bgcolor', 'white',
					...
					<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
						<param name="src" value="media/reel_poster.jpg" />
						<param name="href" value="media/SHOWREEL_600.mov" />
						<param name="target" value="myself" />
						<param name="controller" value="true" />
						<param name="autoplay" value="true" />
						<param name="scale" value="aspect" />
						<embed width="630" height="358" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/"
							src="media/reel_poster.jpg"
							href="SHOWREEL_600.mov"
							target="myself"
							controller="true"
							autoplay="true"
							scale="aspect">
