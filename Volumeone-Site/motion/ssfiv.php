...
<head>
<title>Volumeone | Motion | Super Street Fighter IV</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
				Volumeone worked with <a href="http://wwww.ammirati.com">Ammirati</a> to develop a 30 second TV spot to promote the upcoming Super Street Fighter IV video game. Matt Owens and Athletics partner David Ahuja developed a library of logos and graphic elements to represent each new character. Working with new game play footage, Volumeone edited, designed and animated the spot.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="showreel.php">Next Project</a>
		</div>
	...
	<div class="right_col">
		<div class="slideshow">
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/ssfiv.jpg',
								'media/ssfiv.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
						...
						<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
							<param name="src" value="media/ssfiv.jpg" />
							<param name="href" value="media/ssfiv.mov" />
				...
				<img src="media/ssfiv1.jpg"><br />	<img src="media/ssfiv2.jpg">
			</ul>
		</div>
