...
<head>
<title>Volumeone | Motion | Nick at Nite. Black History Month</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			<h1>Nick at Nite. Black History Month</h1>
			
			<p class="description">
			Design and animation for the John Lee Love spot for Nick at Nite Celebrates Black History Month. We worked with Wes Duvall and David Ahuja at <a href="http://www.athleticsnyc.com/" target="_blank">Athletics</a> to develop a total of 3 spots.
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="mtvsb.php">Next Project</a>
		</div>
			...
			<ul><br />
				<li id="slide_1" class="slide video">
					<script type="text/javascript"><!--
						QT_WritePoster_XHTML('', 'media/nick.jpg',
							'media/nick.mov',
							'630', '354', '',
							'controller', 'true',
							'autoplay', 'true',
					...
					<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
						<param name="src" value="media/nick.jpg" />
						<param name="href" value="media/nick.mov" />
