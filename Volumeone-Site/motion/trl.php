...
<head>
<title>Volumeone | Motion | MTV. TRL</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
Show Package and logo development for the final season of MTV's flagship show Total Request Live.
			</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="meridians.php">Next Project</a>
		</div>
				...
				<ul><br />
					<li id="slide_1" class="slide video">
						<script type="text/javascript"><!--
							QT_WritePoster_XHTML('', 'media/trl.jpg',
								'media/trl.mov',
								'630', '354', '',
								'controller', 'true',
								'autoplay', 'true',
						...
						<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
							<param name="src" value="media/trl.jpg" />
							<param name="href" value="media/trl.mov" />
