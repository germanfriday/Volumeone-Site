...
<head>
<title>Volumeone | Motion | The Road Less Traveled</title>
...
<div id="content">
	...
	<div class="left_col">
		...
		<div class="project_info">
			...
			<p class="description">
				The Road Less Traveled takes its inspiration from  the typographic work of Ed Ruscha and American folk tunes from the likes of Pete Seeger and Bob Dylan.</p><br />

<p>
Story, footage, typography, design and animation by Volumeone.
</p><br />
<p>
Song by Fletcher C. Johnson.
</p>
		</div>
		...
		<div class="sidebar_nav">
			...
			<span>/</span>
			<a href="wilkes.php">Next Project</a>
		</div>
			...
			<ul><br />
				<li id="slide_1" class="slide video">
					<script type="text/javascript"><!--
						QT_WritePoster_XHTML('', 'media/rlt.jpg',
							'media/rlt2.mov',
							'630', '354', '',
							'controller', 'true',
							'autoplay', 'true',
					...
					<object width="630" height="354" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
						<param name="src" value="media/rlt.jpg" />
						<param name="href" value="media/rlt2.mov" />
